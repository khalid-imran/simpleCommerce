                ...
                <div class="col-xl-2 col-lg-2 col-md-6 col-8">
                    <div class="header-right-wrap">
                        ...
                        <div class="same-style cart-wrap">
                            ...
                            <div class="shopping-cart-content" v-if="cartData != null">
                                    ...
                                    <li class="single-shopping-cart" v-for="c in cartData" :class="{'blur-loading': c.loading}">
                                        ...
                                        <div class="shopping-cart-title" style="flex: 9">
                                            ...
                                            <h6 class="d-flex align-items-center">
                                                <span class="me-1">
                                                    <a href="javascript:void(0)" class="d-flex cursor-pointer fw-lighter text-theme" @click="cartRequestToServer(c, 'increase')">
                                                        <i class="fa fa-chevron-up"></i>
                                                    </a>
                                                    <a href="javascript:void(0)" :class="{'disable-arrow': c.cart_quantity < 2 }"  @click="cartRequestToServer(c, 'decrease')"
                                                       class="d-flex cursor-pointer fw-lighter text-theme">
                                                        <i class="fa fa-chevron-down"></i>
                                                    </a>
                                                </span>
                                                <span>Qty: {{ c.cart_quantity }}</span>
                                                <span class="varient-title" v-if="c.variant_title != null" v-tooltip="c.variant_title">{{c.variant_title}}</span>
                                            </h6>
                                            <span>৳ {{c.price}}.00</span>
                                        </div>
                                        <div class="shopping-cart-delete" style="flex: 1">
                                            <a href="javascript:void(0)" @click="removeCart(c)">
                                                <i v-if="!c.removeLoading" class="fa fa-times-circle"></i>
                                ...
                                <div v-else>
                                    <div class="empty-message ng-star-inserted text-center">
                                        ...
                                        <h4 class="text-center text-theme mt-4 mb-2">Your cart is empty</h4>
                                    </div>
                                </div>
                    ...
                    <div class="modal-body pt-3">
                        <div class="col-md-12 ms-auto me-auto">
                            <div class="login-register-wrapper">
                                <div class="login-register-tab-list nav mb-0">
                                    <a class="active">
                                        <h4> login </h4>
                                    </a>
                                </div>
...
export default {
    ...
    methods: {
        ...
        removeCart: function (cart) {
            if (cart.removeLoading) {
                return;
            }
            cart.removeLoading = true
            let param = {
                product_id: cart.id,
            ...
            ApiService.POST(ApiRoutes.DeleteCart, param,(res) => {
                cart.removeLoading = false
                if (parseInt(res.status) === 200) {
                    this.getCart()
                }
            });
        },
        cartRequestToServer: function (cart, type) {
            cart.loading = true
            let param = {
                product_id: cart.id,
                variant_id: cart.variant_id
